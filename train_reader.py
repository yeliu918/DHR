...
from dhr.data.qa_validation import exact_match_score
from dhr.data.reader_data import (
    ReaderSample,
    get_best_spans,
    SpanPrediction,
    convert_retriever_results,
)
from dhr.models import init_reader_components
from dhr.models.reader import create_reader_input, ReaderBatch, compute_loss
    ...
    def validate(self):
        ...
        for q_predictions in all_results:
            ...
            for (n, span_prediction) in span_predictions.items():
                em_hit = max(
                    [
                        exact_match_score(span_prediction.prediction_text, ga, match)
