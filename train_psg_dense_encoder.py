...
from dhr.models.biencoder import BiEncoder, BiEncoderNllLoss, BiEncoderBatch
...
class BiEncoderTrainer(object):
    ...
    def validate_nll(self) -> float:
        ...
        num_hard_insec_negatives = args.insec_negatives
    ...
    def validate_average_rank(self) -> float:
        ...
        num_hard_insec_negatives = args.val_av_rank_insec_neg
