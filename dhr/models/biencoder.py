...
class BiEncoder(nn.Module):
    ...
    def create_biencoder_input(
        ...
        num_hard_insec_negatives: int = 0,
        ...
        for sample in samples:
            ...
            if "hard_sec_ctxs" in sample.keys():
                hard_sec_ctxs = sample["hard_sec_ctxs"]
            if "dhr_negative_ctxs" in sample.keys():
                dhr_negative_ctxs = sample["dhr_negative_ctxs"][0:40]
            ...
            if hard_sec_ctxs:
                hard_sec_ctxs = hard_sec_ctxs[0: num_hard_insec_negatives]
            if dhr_negative_ctxs:
