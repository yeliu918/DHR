...
from dhr.models.hf_models import get_roberta_tensorizer
from .biencoder_mask_loss import BiEncoder
...
class RobertaEncoder(nn.Module):
    ...
    def get_out_size(self):
        return self.fairseq_roberta.model.args.encoder_embed_dim
        # if self.encode_proj:
